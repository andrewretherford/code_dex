...
urlpatterns = [
   ...
   path('records/', login_required(views.RecordsList.as_view()), name='record_list'),
   path('records/<int:pk>', login_required(views.RecordDetail.as_view()), name='record_detail'),
   path('records/<int:pk>/update', login_required(views.RecordUpdate.as_view()), name='record_update'),
